...
### 🚀 Current Work:
- 🛸 Working on a drone system designed according to Defense standards<br>

### 📚 Learning:
- 📈 Focusing on Machine Learning projects and DSA<br>
- 📱 Started Android Development (it's hard tho)<br>

### 📝 Research:
- Written a Research Paper on **Federated Learning** (Results are yet to announce)
